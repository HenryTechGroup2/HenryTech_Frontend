const route = '../assets/armamentPc/';
export const armamentPcImages = [
  {
    img1: {
      imagen: `${route}cpu1.png`,
      name: 'Procesadores',
      description:
  ...
  {
    img1: {
      imagen: `${route}gpu1.png`,
      name: 'Gpu',
      description:
        'El procesador gráfico de una tarjeta es muchísimo más potente que el que tienen los procesadores, por esta razón es necesaria para el buen funcionamiento del equipo y muy recomendada para gamers y profesionales de los gráficos.',
    },

    img2: {
      imagen: `${route}hhd1.png`,
      name: 'Almacenamiento',
      description:
        'Acá es donde se guardarán tus documentos. Se debe tener en cuenta el tamaño y la velocidad. Las unidades SSD son más veloces y pueden ser utilizadas como unidad principal de almacenamiento o como un complemento de un almacenamiento HDD.',
    },
  },
  {
    img1: {
